...
public class GetByIdIncludeIndustriesAsyncTest : IDisposable
{
    private readonly AppDbContext _context;
    private readonly IEventRepository _eventRepository;
    public GetByIdIncludeIndustriesAsyncTest()
    {
    ...
    public async Task ShouldReturnEvent_WhenIdExist()
    {
        ...
        var result = await _eventRepository.GetByIdIncludeIndustriesAsync(id);
